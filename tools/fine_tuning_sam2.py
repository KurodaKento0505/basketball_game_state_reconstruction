...
def train(num_image):
    ...
    # load the model
    #  = "sam2_hiera_base_plus.pt"  # @param ["sam2_hiera_tiny.pt", "sam2_hiera_small.pt", "sam2_hiera_base_plus.pt", "sam2_hiera_large.pt"]
    # model_cfg = "sam2_hiera_b+.yaml" # @param ["sam2_hiera_t.yaml", "sam2_hiera_s.yaml", "sam2_hiera_b+.yaml", "sam2_hiera_l.yaml"]
    # sam2_model = build_sam2(model_cfg, sam2_checkpoint, device="cuda")

    sam2_model = SamModel.from_pretrained("facebook/sam-vit-base")
